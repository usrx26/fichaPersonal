...
const INTRANET_BASE_URL = "http://intranet.carabineros.cl/dipecar/servicios/personal/fichaPersonal.php?CodFunc=";
...
function setupLoginHandler() {
    ...
    if (savedAuth === 'true' && savedRole) {
        ...
        roleBadge.style.color = currentUserRole === 'admin' ? '#eab308' : '#2563eb';
...
function openDetailedProfile(codigoFuncionario) {
    ...
    // Concatenación dinámica para el enlace exclusivo de Intranet
    const intranetLinkCompleto = `${INTRANET_BASE_URL}${funcionario["Codigo Funcionario"]}`;
    ...
    modalContent.innerHTML = `
        <div class="info-profile-grid">
            ...
            <!-- NUEVO: Botón de redirección dinámica a Ficha de Intranet -->
            <a href="${intranetLinkCompleto}" target="_blank" class="btn-intranet-link">
                <i class="fa-solid fa-network-wired"></i> Consultar Ficha Digital Completa <span>Solo Intranet</span>
            </a>
        </div>
    `;
